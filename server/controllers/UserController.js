...
module.exports = {
  getCurrentUser: (req, res) => {
    let sessions = JSON.stringify(req.sessionStore.sessions);
    const userIndex = sessions.lastIndexOf('user');
    sessions = sessions.slice(userIndex + 7);
    const userEnd = sessions.indexOf('}');
    const userID = sessions.slice(0, userEnd);
